...
const ThemeToggle: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`relative p-2 rounded-lg bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-all duration-200 focus-ring ${className}`}
