...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-neutral-800 dark:bg-neutral-950 pt-10 pb-5 transition-colors">
      <div className="flex flex-col md:flex-row md:justify-around px-5 max-w-[1200px] w-full mx-auto mb-8 md:px-6">
        ...
        <div className="mb-8 md:mb-0 md:flex-1 md:mr-5">
          ...
          <button
            onClick={() => handlePhonePress(APP_CONFIG.PHONE_1)}
            className="block mb-3 text-left min-h-[44px] flex items-center"
          ...
          <button
            onClick={() => handlePhonePress(APP_CONFIG.PHONE_2)}
            className="block mb-3 text-left min-h-[44px] flex items-center"
            aria-label={`Позвонить по телефону ${APP_CONFIG.PHONE_2}`}
          >
            <span className="text-sm md:text-base text-neutral-300 dark:text-neutral-400 hover:text-primary-400 dark:hover:text-primary-300 transition-colors hover-underline-animation">
              {APP_CONFIG.PHONE_2}
            </span>
          ...
          <button
            ...
            className="block mb-3 text-left min-h-[44px] flex items-center"
            aria-label={`Написать на email ${APP_CONFIG.EMAIL}`}
          >
            <span className="text-sm md:text-base text-neutral-300 dark:text-neutral-400 hover:text-primary-400 dark:hover:text-primary-300 transition-colors hover-underline-animation">
              {APP_CONFIG.EMAIL}
            </span>
        ...
        <div className="mb-8 md:mb-0 md:flex-1">
          ...
          <button
            ...
            className="block mb-3 text-left min-h-[44px] flex items-center"
            aria-label="Перейти на страницу калькулятора"
          >
            <span className="text-sm md:text-base text-neutral-300 dark:text-neutral-400 hover:text-primary-400 dark:hover:text-primary-300 transition-colors hover-underline-animation">
              Калькулятор
            </span>
          ...
          <button
            ...
            className="block mb-3 text-left min-h-[44px] flex items-center"
            aria-label="Перейти на страницу отзывов"
          >
            <span className="text-sm md:text-base text-neutral-300 dark:text-neutral-400 hover:text-primary-400 dark:hover:text-primary-300 transition-colors hover-underline-animation">
              Отзывы
            </span>
