        ...
        <Card className="p-8 mb-8">
          <div className="flex flex-row justify-between items-center mb-4 flex-wrap gap-4">
            ...
            <div className="flex flex-row items-center gap-4">
              <button
                onClick={prevCase}
                className="w-10 h-10 rounded-full bg-neutral-200 dark:bg-neutral-700 flex items-center justify-center hover:bg-neutral-300 dark:hover:bg-neutral-600 transition-colors min-w-[44px] min-h-[44px]"
          ...
          <div className="flex flex-row flex-wrap gap-2">
            {currentCase.features.map((feature, index) => (
              <div
                key={index}
                className="px-3 py-1.5 bg-primary-100 dark:bg-primary-900/30 rounded-full"
              >
