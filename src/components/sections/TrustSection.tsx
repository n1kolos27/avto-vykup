        ...
        <div className="flex flex-row flex-wrap gap-6 mb-12">
          {trustItems.map((item, index) => (
            <AnimatedCard key={index} delay={index * 100}>
              <Card hover3D className="flex-1 min-w-[200px] flex flex-col items-center p-6">
              <div
                className="w-16 h-16 rounded-full flex items-center justify-center mb-4 dark:opacity-80"
