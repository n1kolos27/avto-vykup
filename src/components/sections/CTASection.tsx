...
export type CTASectionVariant = 'primary' | 'secondary' | 'urgent' | 'minimal';
...
interface CTASectionProps {
  ...
  buttonAction?: () => void;
  showPhone?: boolean;
  phoneVariant?: 'primary' | 'secondary' | 'ghost';
...
const CTASection: React.FC<CTASectionProps> = ({
  ...
  const getSubtitleClasses = (): string => {
      ...
      <div className="max-w-[1200px] w-full mx-auto flex flex-col items-center z-10">
        ...
        {customContent || (
          <div className="flex flex-row flex-wrap gap-5 justify-center items-center">
            ...
            {showPhone && (
              <PhoneButton phone={phone1} variant={phoneVariant} size="lg" />
            )}
          </div>
        )}
      </div>
