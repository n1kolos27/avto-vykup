...
const StatsSection: React.FC = () => {
  return (
    <section className="bg-neutral-50 dark:bg-neutral-900 py-16 px-4 md:py-20 md:px-6 transition-colors relative">
      ...
      <div className="max-w-[1200px] w-full mx-auto flex flex-row flex-wrap gap-6">
        {stats.map((stat, index) => (
          <AnimatedCard key={index} delay={index * 100}>
            <div className="flex-1 min-w-[200px] bg-white dark:bg-neutral-800 p-6 rounded-xl flex flex-col items-center shadow-md dark:shadow-dark-md md:p-8 transition-colors">
