      ...
      <div className="max-w-[1200px] w-full mx-auto px-4">
            ...
            <div className="flex flex-row items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="text-base text-primary-600 underline"
                >
                  {APP_CONFIG.EMAIL}
                </a>
              </div>
        ...
        <Card className="bg-primary-600 p-6 mb-6">
          ...
          <div className="flex flex-col gap-3">
            {['Оценка за 5 минут', 'Честная рыночная цена', 'Моментальная оплата', 'Официальное оформление', 'Работаем с любым состоянием'].map((advantage) => (
              <div key={advantage} className="flex flex-row items-center gap-3">
