...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Для срочного выкупа нужны те же документы, что и для обычного: ПТС, СТС, паспорт владельца. Мы поможем оформить все необходимые документы.',
  },
  {
    question: 'Можно ли получить деньги наличными?',
    answer:
      'Да, мы предлагаем несколько способов оплаты: наличными, переводом на банковскую карту, банковским переводом. Вы можете выбрать наиболее удобный для вас вариант.',
  },
];
