...
export const metadata: Metadata = genMeta({
  title: 'Гарантии при выкупе авто | Безопасность сделки | Юридическая защита',
  description:
    'Что мы гарантируем при выкупе автомобиля в Москве и МО. Юридическая безопасность, прозрачность документов, защита от мошенников, честная цена, гарантия скорости. Официальное оформление. 10+ лет опыта, 5000+ клиентов.',
  keywords:
