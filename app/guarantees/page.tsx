...
export const metadata: Metadata = genMeta({
  title: 'Гарантии при выкупе авто | Что мы гарантируем',
  description:
    'Что мы гарантируем при выкупе автомобиля. Юридическая безопасность, прозрачность документов, защита от мошенников, честная цена, гарантия скорости. Официальное оформление.',
  keywords:
    'гарантии выкуп авто, безопасность сделки, юридическая защита, защита от мошенников, гарантия цены, официальное оформление',
  path: '/guarantees',
});
