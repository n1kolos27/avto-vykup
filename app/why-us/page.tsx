...
export const metadata: Metadata = genMeta({
  title: 'Почему выбирают нас | Выкуп авто Москва | Преимущества',
  description:
    'Преимущества нашей компании по выкупу автомобилей в Москве и МО. Почему выбирают нас: скорость (выкуп за 2 часа), честная цена (до 97%), безопасность, опыт (10+ лет), профессионализм.',
  keywords:
