...
export const metadata: Metadata = genMeta({
  title: 'Почему выбирают нас | Преимущества компании',
  description:
    'Конкурентные преимущества нашей компании. Почему клиенты выбирают именно нас для выкупа автомобилей. Скорость, честная цена, безопасность, опыт, профессионализм.',
  keywords:
    'почему мы, преимущества, конкурентные преимущества, почему выбирают, лучшая компания, лидер рынка',
  path: '/why-us',
});
