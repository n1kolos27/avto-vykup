...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'Выкуп Авто Москва ⚡ Срочный Выкуп за 2 часа',
    description:
      '🏆 Выкуп авто в Москве и МО. ⚡ Срочный выкуп за 2 часа. 💰 Оценка за 5 минут. ✅ Честная цена. 💵 Моментальная оплата. ⭐ 5.0 рейтинг, 5000+ клиентов',
    siteName: 'Выкуп авто',
    locale: 'ru_RU',
    type: 'website',
    images: [
  ...
  twitter: {
    ...
    title: 'Выкуп Авто Москва ⚡ Срочный Выкуп за 2 часа',
    description:
      '🏆 Выкуп авто в Москве и МО. ⚡ Срочный выкуп за 2 часа. 💰 Оценка за 5 минут. ✅ Честная цена. 💵 Моментальная оплата',
