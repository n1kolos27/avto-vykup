...
export const metadata: Metadata = genMeta({
  title: 'Калькулятор стоимости автомобиля | Онлайн расчет цены выкупа',
  description:
    'Быстрый расчет стоимости выкупа вашего автомобиля онлайн. Узнайте предварительную цену за 2 минуты. Бесплатно и без регистрации. Учитываем марку, модель, год, пробег, состояние. До 97% рыночной стоимости. Москва и МО.',
  keywords:
