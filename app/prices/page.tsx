...
export const metadata: Metadata = genMeta({
  title: 'Цены на выкуп авто | До 97% рыночной стоимости | Москва',
  description:
    'Прозрачное ценообразование при выкупе автомобилей в Москве и МО. Как мы определяем цену, что влияет на стоимость. Факторы: марка, год, пробег, состояние, комплектация. До 97% рыночной стоимости. Честная оценка.',
  keywords:
