...
export const metadata: Metadata = genMeta({
  title: 'Документы для выкупа авто | ПТС СТС | Список | Москва',
  description:
    'Полный список документов для выкупа автомобиля в Москве и МО. ПТС, СТС, паспорт владельца. Что нужно подготовить перед продажей. Особые случаи: кредит, залог.',
  keywords:
