...
export const metadata: Metadata = genMeta({
  title: 'Отзывы клиентов о выкупе авто | Реальные отзывы | Рейтинг 5 звезд | Москва и МО',
  description:
    'Реальные отзывы наших клиентов о выкупе автомобилей в Москве и МО. Более 12 отзывов с рейтингом 5 звезд. 5000+ довольных клиентов. Читайте истории успешных сделок: срочный выкуп, выкуп битых авто, после ДТП, кредитных и премиум авто.',
  keywords:
    'отзывы выкуп авто, отзывы клиентов выкуп авто, реальные отзывы выкуп автомобилей, отзывы выкуп авто москва, рейтинг компании выкуп, отзывы о выкупе авто, отзывы выкуп автомобилей москва, положительные отзывы выкуп авто, отзывы клиентов о выкупе',
  path: '/reviews',
});
