...
export const metadata: Metadata = genMeta({
  title: 'Отзывы о выкупе авто | Реальные отзывы | Рейтинг 5.0',
  description:
    'Реальные отзывы клиентов о выкупе автомобилей в Москве и МО. Более 12 отзывов с рейтингом 5 звезд. 5000+ довольных клиентов. Истории успешных сделок: срочный выкуп, битых авто, после ДТП, кредитных и премиум.',
  keywords:
