...
export const metadata: Metadata = genMeta({
  title: 'Срочный выкуп автомобилей за 2 часа | Быстрый выкуп авто Москва',
  description:
    'Срочный выкуп автомобилей за 2 часа в Москве и МО. Быстрый выкуп авто с моментальной оплатой. Работаем с 9:00 до 22:00 ежедневно. Оценка за 5 минут. Звоните: 89857520001',
  keywords:
