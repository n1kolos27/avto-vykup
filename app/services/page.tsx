...
export const metadata: Metadata = genMeta({
  title: 'Услуги по выкупу автомобилей | Полный спектр | Москва',
  description:
    'Полный спектр услуг по выкупу автомобилей в Москве и МО. Выкуп легковых и коммерческих авто, после ДТП, кредитных, премиум. Помощь с документами, эвакуатор.',
  keywords:
