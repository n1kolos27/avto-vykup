...
export const metadata: Metadata = genMeta({
  title: 'Выкуп автомобилей после ДТП | Выкуп авто после аварии Москва',
  description:
    'Выкуп автомобилей после ДТП в Москве и МО. Выкупаем авто после аварий с любыми повреждениями. Оценка остаточной стоимости, восстановление vs разбор. Звоните: 89857520001',
  keywords:
