...
export const metadata: Metadata = genMeta({
  title: 'Выкуп премиум авто | Элитные автомобили | Москва',
  description:
    'Выкуп премиум и элитных автомобилей в Москве и МО. Специализируемся на выкупе авто премиум класса. Профессиональная оценка, максимальная цена. Звоните: 89857520001',
  keywords:
