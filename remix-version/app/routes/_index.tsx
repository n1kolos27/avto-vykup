...
import MoscowBuybackSection from '~/components/sections/MoscowBuybackSection';
import HowToSellSection from '~/components/sections/HowToSellSection';
import WhatCarsWeBuySection from '~/components/sections/WhatCarsWeBuySection';
import AnyConditionSection from '~/components/sections/AnyConditionSection';
...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: "description", content: "Профессиональный выкуп автомобилей в Москве и Московской области. Срочный выкуп за 2 часа, быстрая оценка за 5 минут, честная рыночная цена." },
  ];
};
  ...
  return (
    <div className="flex-1">
      ...
      <CTASection
        ...
        subtitle="Заполните форму и получите бесплатную оценку вашего автомобиля за 5 минут"
      ...
      <CTASection
        ...
        subtitle="Задайте нам вопрос или получите бесплатную оценку вашего автомобиля"
