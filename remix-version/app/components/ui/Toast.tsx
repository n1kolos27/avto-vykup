...
const ToastComponent: React.FC<ToastProps> = ({ toast, onClose }) => {
  ...
  return (
    <div
      className={`flex flex-row items-center px-4 py-3 rounded-lg border min-h-[48px] mb-2 shadow-md dark:shadow-dark-md transition-all duration-200 ${
        colors.bg
      } ${colors.border} ${
    ...
    >
      ...
      <button
        onClick={handleClose}
        className={`ml-3 p-1 ${colors.text} hover:opacity-70 transition-opacity`}
