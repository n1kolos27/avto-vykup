      ...
      <div className="max-w-[1200px] w-full mx-auto px-4">
        ...
        <div className="flex flex-col items-center py-12 mb-8">
          ...
          <p className="text-sm text-neutral-600 text-center max-w-[600px]">
            ...
            <button onClick={() => navigate('/services/urgent-buyback')} className="text-primary-600 underline">
              срочный выкуп
            </button>
            ,{' '}
            ...
            ,{' '}
            <button onClick={() => navigate('/services/after-accident')} className="text-primary-600 underline">
              выкуп после ДТП
            </button>
            ,{' '}
            <button onClick={() => navigate('/services/credit-cars')} className="text-primary-600 underline">
              выкуп кредитных авто
            </button>
            ,{' '}
            <button onClick={() => navigate('/services/premium-cars')} className="text-primary-600 underline">
              выкуп премиум авто
            </button>
            .
          </p>
        ...
        <Card className="p-8 mb-8">
          ...
          <p className="text-base text-neutral-700 leading-7 mb-4">
            ...
            <button onClick={() => navigate('/calculator')} className="text-primary-600 underline">
              онлайн-калькулятор
            </button>{' '}
          ...
          <p className="text-base text-neutral-700 leading-7 mb-4">
            ...
            или вычетов нет.{' '}
            <button onClick={() => navigate('/guarantees')} className="text-primary-600 underline">
          ...
          <p className="text-base text-neutral-700 leading-7">
            ...
            <button onClick={() => navigate('/services')} className="text-primary-600 underline">
        ...
        <Card className="p-8 mb-8">
          ...
          <div className="flex flex-col gap-4">
            {factors.map((factor, index) => (<Card key={index} className="p-4 border border-neutral-200">
