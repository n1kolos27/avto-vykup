    ...
    return (<div className="flex-1 bg-neutral-50">
      ...
      <div className="max-w-[1200px] w-full mx-auto px-4">
        ...
        <div className="flex flex-row flex-wrap gap-6 mb-8">
          {achievements.map((achievement, index) => (<div key={index} className="flex-1 min-w-[250px] bg-white rounded-xl p-6 shadow-md">
        ...
        <div className="py-8">
          <SectionCTA title="Готовы продать свой автомобиль?" description="Свяжитесь с нами и получите оценку за 5 минут"/>
        </div>
      </div>
    </div>);
};
