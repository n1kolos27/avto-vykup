    ...
    return (<ThemeProvider>
      <div className="flex flex-col min-h-screen w-full bg-white dark:bg-neutral-900 transition-colors">
        ...
        <div className="sr-only focus-within:not-sr-only focus-within:absolute focus-within:top-4 focus-within:left-4 focus-within:z-[9999] focus-within:flex focus-within:flex-col focus-within:gap-2">
          <a href="#main-content" className="px-4 py-2 bg-primary-600 dark:bg-primary-500 text-white rounded-lg font-semibold shadow-lg focus-ring">
            Перейти к основному содержимому
          </a>
          <a href="#navigation" className="px-4 py-2 bg-primary-600 dark:bg-primary-500 text-white rounded-lg font-semibold shadow-lg focus-ring">
            Перейти к навигации
          </a>
        </div>
        ...
        <Header />
        <main ref={mainRef} id="main-content" className="flex-1 w-full page-transition focus-visible-ring" tabIndex={-1} key={location.pathname} role="main" aria-label="Основное содержимое страницы">
          {children}
        </main>
        <Footer />
        <ToastProvider />
