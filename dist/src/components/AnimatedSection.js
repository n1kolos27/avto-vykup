...
const AnimatedSection = ({ children, delay = 0, className = '', animationType = 'fade-slide', }) => {
    ...
    return (_jsx("div", { ref: sectionRef, className: `${getAnimationClasses()} ${!prefersReducedMotion ? 'will-change-transform will-change-opacity' : ''} ${className}`, children: children }));
};
