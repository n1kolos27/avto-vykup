...
const RelatedServices = ({ currentPath, services = defaultServices }) => {
    ...
    return (<section className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {relatedServices.map((service) => (<Card key={service.path} className="p-6 hover:shadow-lg transition-shadow flex flex-col">
            ...
            <Button onClick={() => navigate(service.path)} variant="secondary" className="w-full">
              Узнать больше
            </Button>
          </Card>))}
      </div>
