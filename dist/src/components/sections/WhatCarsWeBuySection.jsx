    ...
    return (<section className="bg-white dark:bg-neutral-900 py-16 px-4 transition-colors relative">
      ...
      <div className="max-w-[1200px] w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {categories.map((category, index) => (<AnimatedCard key={index} delay={index * 100}>
        ...
        <div className="flex flex-row flex-wrap gap-4 justify-center">
          <Button onClick={() => navigate('/services')} variant="primary" className="min-w-[200px]">
            Посмотреть все услуги
          </Button>
          <Button onClick={() => navigate('/car-brands')} variant="outline" className="min-w-[200px]">
