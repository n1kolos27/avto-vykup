...
const UrgencySection = () => {
    ...
    return (<section className="cta-urgent-gradient py-20 px-4 relative">
      <div className="max-w-[1200px] w-full mx-auto relative z-10">
        ...
        <div className="glass-morphism-subtle rounded-3xl p-8 border border-white/30 mb-12">
          ...
          <div className="flex flex-row flex-wrap gap-4 justify-center items-center">
            <Button onClick={() => navigate('/calculator')} size="lg" variant="secondary" className="min-w-[240px] flex-1">
        ...
        <div className="mt-4">
          ...
          <AnimatedSection animationType="stagger" delay={200}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (<AnimatedCard key={index} delay={index * 100}>
                  <Card hover3D variant="outlined" className="bg-white/10 dark:bg-white/5 p-8 flex flex-col items-center border border-white/30 dark:border-white/20 transition-colors h-full">
