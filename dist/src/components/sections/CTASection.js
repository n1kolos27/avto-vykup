...
const CTASection = ({ variant = 'primary', title, subtitle, buttonText = 'УЗНАТЬ ЦЕНУ →', buttonAction, showPhone = false, phoneVariant = 'secondary', customContent, className = '', }) => {
    ...
    return (_jsx("section", { className: `${getContainerClasses()} ${className}`, children: _jsxs("div", { className: "max-w-[1200px] w-full mx-auto flex flex-col items-center z-10", children: [_jsx("h2", { className: getTitleClasses(), children: title }), subtitle && (_jsx("p", { className: getSubtitleClasses(), children: subtitle })), customContent || (_jsxs("div", { className: "flex flex-row flex-wrap gap-5 justify-center items-center", children: [_jsx(Button, { onClick: handleButtonClick, size: "lg", variant: getButtonVariant(), className: "min-w-[300px]", children: buttonText }), showPhone && (_jsx(PhoneButton, { phone: phone1, variant: phoneVariant, size: "lg" }))] }))] }) }));
};
