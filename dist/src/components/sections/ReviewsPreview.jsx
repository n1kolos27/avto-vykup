...
const ReviewsPreview = () => {
    ...
    return (<section className="bg-neutral-50 dark:bg-neutral-900 py-16 px-4 md:py-20 md:px-6 transition-colors">
      <div className="max-w-[1200px] w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {reviews.map((review) => (<Card key={review.id} className="p-6 h-full">
        ...
        <div className="flex justify-center">
          <Button onClick={() => navigate('/reviews')} variant="outline" size="lg" className="min-w-[250px]">
