      ...
      <div className="max-w-[1200px] w-full mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {steps.map((step, index) => (<AnimatedCard key={index} delay={index * 100}>
              ...
              {index < steps.length - 1 && (<div className="hidden md:block absolute z-0 bg-primary-200 dark:bg-primary-800" style={{
                    top: 32,
                    left: '100%',
                    width: '50%',
                    height: 2,
        ...
        <div className="mt-12">
          <SectionCTA title="Готовы начать?" description="Свяжитесь с нами и получите оценку за 5 минут" variant="secondary"/>
        </div>
      </div>
    </section>);
};
