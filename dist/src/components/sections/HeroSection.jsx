...
const HeroSection = () => {
    ...
    return (<section className="cta-primary-gradient py-16 px-4 relative overflow-hidden md:py-20 md:px-6">
      <div className="max-w-[1200px] w-full mx-auto relative z-10">
        ...
        <div className="flex flex-row gap-3 mb-6 flex-wrap">
          <Button onClick={() => navigate('/calculator')} size="lg" variant="secondary" className="min-w-[200px] flex-shrink-0">
        ...
        <div className="flex flex-row items-center gap-3 mb-6 flex-wrap">
          <div className="flex flex-row -mr-2">
            {[1, 2, 3, 4].map((i) => (<div key={i} className="w-8 h-8 rounded-full bg-white/20 border-2 border-white/30 flex items-center justify-center -ml-2">
        ...
        <div className="flex flex-row flex-wrap gap-3 mb-6">
          {trustBadges.map((badge, index) => (<div key={index} className="flex flex-row items-center bg-white/10 px-4 py-2.5 rounded-lg border border-white/20 gap-2">
        ...
        <div className="flex flex-row flex-wrap gap-3">
          {features.map((feature, index) => (<div key={index} className="flex flex-row items-center bg-white/10 px-4 py-2.5 rounded-lg border border-white/20 gap-2">
