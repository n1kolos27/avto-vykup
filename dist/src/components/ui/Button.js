...
const Button = ({ variant = 'primary', size = 'md', isLoading = false, isSuccess = false, isError = false, magnetic = false, loadingProgress, children, title, onClick, disabled = false, className = '', testID, ...props }) => {
    ...
    return (_jsxs("button", { ref: buttonRef, className: `${baseClasses} ${getVariantClasses()} ${getSizeClasses()} ${hoverClasses} ${className}`, onClick: handleClick, disabled: isDisabled, "data-testid": testID, "aria-busy": isLoading, "aria-disabled": isDisabled, ...props, children: [ripples.map((ripple) => (_jsx("span", { className: "absolute rounded-full bg-white/50 dark:bg-white/30 ripple pointer-events-none", style: {
                    left: `${ripple.x}px`,
                    top: `${ripple.y}px`,
                    width: '0',
                    height: '0',
                ...
                } }, ripple.id))), isLoading ? (_jsxs(_Fragment, { children: [_jsxs("svg", { className: "animate-spin -ml-1 mr-2 h-4 w-4 text-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] }), loadingProgress !== undefined ? (_jsxs("span", { className: "flex items-center gap-2", children: [_jsx("span", { children: "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..." }), _jsxs("span", { className: "text-xs opacity-75", children: [loadingProgress, "%"] })] })) : (_jsx("span", { children: "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..." })), loadingProgress !== undefined && (_jsx("div", { className: "absolute bottom-0 left-0 right-0 h-1 bg-white/20 rounded-b-lg overflow-hidden", children: _jsx("div", { className: "h-full bg-white/60 progress-bar-animated", style: { width: `${loadingProgress}%` } }) }))] })) : isSuccess ? (_jsxs("span", { className: "relative z-10 flex items-center gap-2", children: [_jsx("span", { className: "success-check", children: "\u2713" }), _jsx("span", { children: displayText })] })) : isError ? (_jsxs("span", { className: "relative z-10 flex items-center gap-2", children: [_jsx("span", { children: "\u2715" }), _jsx("span", { children: displayText })] })) : (_jsx("span", { className: "relative z-10", children: displayText }))] }));
};
